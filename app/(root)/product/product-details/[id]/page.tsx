      ...
      <div className="w-4/5 mx-auto grid grid-cols-1 lg:grid-cols-7 items-center gap-4">
        ...
        <div className="col-span-4">
          ...
          <div className="mt-2 flex items-center space-x-2">
            ...
            <p className="text-base">({singleProduct?.rating.count} Reviews) </p>
          </div>
          ...
          <p className="mt-4 text-sm text-black text-opacity-70 font-semibold">{singleProduct?.category}</p>
          <p className="mt-4 text-sm text-black text-opacity-70 font-semibold">Tag:Shop</p>
          <p className="mt-4 text-sm text-black text-opacity-70 font-semibold">SKU : {Math.random() * 500}</p>
          <AddToCart product={singleProduct} />
        </div>
      </div>
      <div className="w-4/5 mx-auto mt-16">
        <h1 className='font-semibold text-black text-3xl lg:text4xl '>Related Products</h1>
